...
/**
 * MinIO object upload helper (infrastructure). Kept under {@code support}
 * rather than domain {@code service} because it has no business entity/API surface.
 */
@Service
...
public class MinioUploadService {
    ...
    public boolean uploadAvatarImg(MultipartFile file, String objectFileName) {
        return putObject("img/avatarImages/" + objectFileName, file);
    }
